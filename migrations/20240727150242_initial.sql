...
INSERT INTO users(id, ws_id, fullname, email, password_hash)
    VALUES(0, 0, 'super user', 'superuser@none.com', '');
INSERT INTO workspaces(id, name, owner_id)
    VALUES(0, 'none', 0);
COMMIT;

-- add foerign key constraint for ws_id for users
ALTER TABLE users
    ADD CONSTRAINT users_ws_id FOREIGN KEY (ws_id) REFERENCES workspaces(id);
